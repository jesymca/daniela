...
try {
    ...
    die("Error al consultar proveedor: " . $e->getMessage());
}
...
<div class="container mt-4">
    ...
    <form method="post">
        ...
        <div class="mb-3">
            ...
            <textarea class="form-control" id="direccion" name="direccion"><?php echo htmlspecialchars($proveedor['direccion']); ?></textarea>
        </div>
